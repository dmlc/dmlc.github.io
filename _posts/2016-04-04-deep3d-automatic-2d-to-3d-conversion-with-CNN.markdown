...
## Code & Paper
This work is done with [MXNet](https://github.com/dmlc/mxnet), a flexible and efficient deep learning package. Our code is released [here](https://github.com/piiswrong/deep3d) The trained model and a prediction script is in [deep3d.ipynb](https://github.com/piiswrong/deep3d). We will release the code for training shortly.
